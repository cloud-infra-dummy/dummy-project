...
public class TestSNWithSpyDAO extends TestSNAbstractGeneric {
    ...
    public void setUp() throws Exception {
        ...
        AccountDAOFake spy = spy((AccountDAOFake) DAOFactory.getInstance().getAccountDAOFake());
        doReturn(false).when(spy).isFullFake();
        accountDAO = spy;
        super.setUp();
		assertFalse(spy.isFullFake());
	}
    ...
    public void willAttemptToPersistAcceptanceOfFriendRequest()
		...
		assertTrue(accountDAO.findByUserName("John").getFriends().contains("Hakan"));
		assertTrue(accountDAO.findByUserName("Hakan").getFriends().contains("John"));
    }
